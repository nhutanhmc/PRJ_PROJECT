 ...
 * @author nhuta
 */
@WebFilter(filterName = "AutherMainFilter", urlPatterns = {"/*"})
public class AutherMainFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("AutherMainFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("AutherMainFilter:DoAfterProcessing");
        }
        ...
        try {
            ...
            for (String value : NON_AUTHEN_FUNCTIONS){
                ...
                if (session == null || user == null) {
                    ...
                    //user dang nhap voi quyen ad va truy cap tai nguyen duoc
                    //cho phep cua role AD
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("AutherMainFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("AutherMainFilter()");
        }
        StringBuffer sb = new StringBuffer("AutherMainFilter(");
